...
public class TheMathGame3 extends JFrame implements ItemListener,ActionListener{
	...
	public void actionPerformed(ActionEvent e){
    	 ...
    	 if(e.getSource()== btnStart) {
    			...
    			num1 = (int) (Math.random()*(30 - 21) + 21); // generating number 0 - 5
				num2 = (int) (Math.random()*(30 - 21) + 21);
    			result = num1+num2;	
    			question = (" " + num1+ " + "+ num2);
    			}
