...
public class TheMathGame extends JFrame implements ItemListener,ActionListener{
	...
	public void actionPerformed(ActionEvent e){
    	 ...
    	 if(e.getSource()== btnStart) {
    			...
    			num1 = (int) (Math.random()*11); // generating number 0 - 5
	...
	public TheMathGame(){
    	...
    	btnCheck.setBounds(520,520,110,50);
    	answer.setBounds(340,480,100,60);
    	btnStart.setBounds(520,460,110,50);
    	questionShown.setBounds(160,60,650,500);
